    ...
    async def proceed_split(self, dl_path, gid):
        ...
        if self.files_to_proceed:
            ...
            for f_path, (f_size, file_) in self.files_to_proceed.items():
                ...
                orig_is_video, orig_is_audio, orig_is_image = await get_document_type(
                    f_path
                )
                ...
                self.file_details.setdefault("document_type", {})[file_] = (
                    orig_is_video,
                    orig_is_audio,
                    orig_is_image,
                )
                ...
                if not self.as_doc and self.media_split and orig_is_video:
                    self.progress = True
